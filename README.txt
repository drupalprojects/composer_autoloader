...
2. Go to http://example.com/admin/modules and enable the Composer Autoloader (or do so with drush with the command `drush pm-enable composer_manager`).

## Configuration
The default configuration is to load autoload.php that is located in '../vendor/autoload.php'. The default assumes that your vendor directory is just outside your webroot. If you need to customize this, you can do so by adding the following line to your setting.php file:
